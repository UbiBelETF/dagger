...
struct Player
{
        ...
        
    {
        ...
        chr.currentLvl.legend['F'] = CreateObjectFunction("lab:door:lab anims_Animation 5_00",30,true,2,107.1f,"lab:door",false,0);//Door;
        ...
        chr.currentLvl.legend['T'] = CreateObjectFunction("spritesheets:lab:tank_classic",20,true,-1,100.0f,"",false,0);
