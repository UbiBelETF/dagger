...
void PlatformerCollisionsSystem::Run()
{
    auto view = Engine::Registry().view<PlatformerCollision, Transform>();
    auto it = view.begin();
...
bool PlatformerCollision::IsCollided(const Vector3& pos_, const PlatformerCollision& other_, const Vector3& posOther_)
{
...
Vector2 PlatformerCollision::GetCollisionSides(const Vector3& pos_, const PlatformerCollision& other_, const Vector3& posOther_)
{
    Vector2 res(0, 0);
...
Vector3 PlatformerCollision::GetCollisionCenter(const Vector3& pos_, const PlatformerCollision& other_, const Vector3& posOther_)
{
    Vector3 res;
